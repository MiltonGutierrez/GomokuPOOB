...
public class PvpNormal extends JPanel {
        ...
        boton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e){
                if(Gomoku.getGomoku().validPlay(fila, columna)){
                    ...
                    JOptionPane.showMessageDialog(null, "Movimiento Invalido", "Informaci�n", JOptionPane.INFORMATION_MESSAGE);
                }
            }
        }); 
        return boton;
    ...
    public void validateWinCondition(){
        if(Gomoku.getGomoku().getGomokuFinished()){ 
            JOptionPane.showMessageDialog(this, "Juego Terminado\n" + Gomoku.getGomoku().getWinner(), "Informaci�n", JOptionPane.INFORMATION_MESSAGE);
        }
    }
