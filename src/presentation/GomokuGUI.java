...
public class GomokuGUI extends JFrame{
    ...
    public JPanel createBoardTokenInformation() {
        ...
        gbc.insets = new Insets(0, 10, 0, 0);
        Font arial = new Font("italic", 1, 14);
        JLabel fichasDisponiblesP1 = new JLabel("Fichas Restantes " + p1Name);
        fichasDisponiblesP1.setFont(arial);
        tokensLeft.add(fichasDisponiblesP1, gbc);
        gbc.gridy = 1;
        tokensLeft.add(Box.createVerticalStrut(5), gbc);
        gbc.gridy = 2;
        JLabel normalTokenLeftP1 = new JLabel("Piedras normales restantes: " + Gomoku.getGomoku().getTokensLeft(p1Name, "Normal"));
        normalTokenLeftP1.setFont(arial);
        tokensLeft.add(normalTokenLeftP1, gbc);
        gbc.gridy = 3;
        JLabel heavyTokenLeftP1 = new JLabel("Piedras pesadas restantes: " + Gomoku.getGomoku().getTokensLeft(p1Name, "Heavy"));
        heavyTokenLeftP1.setFont(arial);
        tokensLeft.add(heavyTokenLeftP1, gbc);
    
        gbc.gridy = 4;
        JLabel temporalTokenLeftP1 = new JLabel("Piedras temporales restantes: " + Gomoku.getGomoku().getTokensLeft(p1Name, "Temporal"));
        ...
        gbc.gridy = 6;
        JLabel fichasDisponiblesP2 = new JLabel("Fichas Restantes " + p2Name);
        ...
        tokensLeft.add(Box.createVerticalStrut(5), gbc);
        gbc.gridy = 8;
        JLabel normalTokenLeftP2 = new JLabel("Piedras normales restantes: " + Gomoku.getGomoku().getTokensLeft(p2Name, "Normal"));
        normalTokenLeftP2.setFont(arial);
        tokensLeft.add(normalTokenLeftP2, gbc);
        gbc.gridy = 9;
        JLabel heavyTokenLeftP2 = new JLabel("Piedras pesadas restantes: " + Gomoku.getGomoku().getTokensLeft(p2Name, "Heavy"));
        heavyTokenLeftP2.setFont(arial);
        tokensLeft.add(heavyTokenLeftP2, gbc);
        gbc.gridy = 10;
        JLabel temporalTokenLeftP2 = new JLabel("Piedras temporales restantes: " + Gomoku.getGomoku().getTokensLeft(p2Name, "Temporal"));
    ...
    public void addListenersTokens(){
        selectNormal.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e){
                Gomoku.getGomoku().changeTypeOfToken("Normal");
            }});

        selectHeavy.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e){
                Gomoku.getGomoku().changeTypeOfToken("Heavy");
            }
        });

        selectTemporal.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e){
                Gomoku.getGomoku().changeTypeOfToken("Temporal");
            }
        });
    }
            ...
            public void actionPerformed(ActionEvent e){
                try {
                    if(Gomoku.getGomoku().validPlay(fila, columna)){
                        Gomoku.getGomoku().play(fila, columna, Gomoku.getGomoku().getCurrentToken());
                        updateTokensOnBoard();
